...
`docker run -d -p 7000:7000 -v /your/jdbc/ojdbc7.jar:/app/ojdbc7.jar -v /your/config/directory:/config -v /your/secrets/directory:/passwords tjheslin1/patterdale:0.16.0`
