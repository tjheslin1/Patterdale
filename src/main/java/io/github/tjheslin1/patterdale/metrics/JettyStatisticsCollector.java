...
public class JettyStatisticsCollector extends Collector {
    ...
    // taken from: https://github.com/prometheus/client_java/blob/master/simpleclient_jetty/src/main/java/io/prometheus/client/jetty/JettyStatisticsCollector.java
    ...
    private static MetricFamilySamples buildGauge(String name, String help, double value) {
        return new MetricFamilySamples(
                ...
                Type.GAUGE,
                help,
                Collections.singletonList(new MetricFamilySamples.Sample(name, emptyList(), emptyList(), value)));
    }
