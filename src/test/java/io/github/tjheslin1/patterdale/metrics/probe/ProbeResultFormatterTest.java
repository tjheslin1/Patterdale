...
public class ProbeResultFormatterTest implements WithAssertions {
    ...
    private static final Probe PROBE_1 = probe("healthCheck", "SQL", "type", "metricName", "metricLabels=\"1\"");
    private static final Probe PROBE_2 = probe("slowestQueries", "SQL2", "type2", "metricName2", "metricLabels=\"1\",key=\"%s\",label=\"%s\"");
